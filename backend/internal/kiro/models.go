...
var DefaultModels = []Model{
	...
	{ID: "claude-opus-5-0", Type: "model", DisplayName: "Claude Opus 5"},
	{ID: "claude-opus-5-0-thinking", Type: "model", DisplayName: "Claude Opus 5 (Thinking)"},
	...
	{ID: "claude-sonnet-5-0", Type: "model", DisplayName: "Claude Sonnet 5"},
	{ID: "claude-sonnet-5-0-thinking", Type: "model", DisplayName: "Claude Sonnet 5 (Thinking)"},
