...
type UsageLog struct {
	...
	SessionID *string
	// KiroSessionFingerprint is an irreversible, admin-only audit correlation value.
	KiroSessionFingerprint *string
	// PreviousKiroAccountID is populated only for administrator usage history views.
	PreviousKiroAccountID *int64
