...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=docker.io/tamakiramimy/sub2api-kiro:latest
...
SUB2API_IMAGE=docker.io/tamakiramimy/sub2api-kiro:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
