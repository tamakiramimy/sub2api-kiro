...
### 6) `doc_url` 配置建议
- 查看链接：`https://github.com/tamakiramimy/sub2api-kiro/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- 下载链接：`https://raw.githubusercontent.com/tamakiramimy/sub2api-kiro/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
...
- View URL: `https://github.com/tamakiramimy/sub2api-kiro/blob/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
- Download URL: `https://raw.githubusercontent.com/tamakiramimy/sub2api-kiro/main/docs/ADMIN_PAYMENT_INTEGRATION_API.md`
