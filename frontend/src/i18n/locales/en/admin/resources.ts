export default {
    ...
    usage: {
      ...
      user: 'User',
      account: 'Account',
      kiroSession: 'Kiro Session',
      kiroSessionPlaceholder: 'Enter full session fingerprint',
      kiroSessionBound: 'Account bound',
      kiroSessionMaintained: 'Account retained',
      kiroSessionSwitched: 'Switched: #{previous} -> #{current}',
      group: 'Group',
      ...
      cacheReadShort: 'Read',
      kiroCacheLocalSimulation: 'Local simulation',
      kiroCacheLocalSimulationHint: 'Kiro cache data only simulates Sub2API usage and billing categories. It does not mean the upstream cache was hit and does not reduce upstream tokens or quota usage.',
