export default {
    ...
    usage: {
      ...
      account: '账户',
      kiroSession: 'Kiro 会话',
      kiroSessionPlaceholder: '输入完整会话指纹',
      kiroSessionBound: '绑定账号',
      kiroSessionMaintained: '保持账号',
      kiroSessionSwitched: '已切换：#{previous} -> #{current}',
      group: '分组',
      requestId: '请求ID',
      ...
      cacheReadShort: 'Read',
      kiroCacheLocalSimulation: '本地模拟',
      kiroCacheLocalSimulationHint: 'Kiro cache 数据仅为 Sub2API 本地 usage 与计费分类模拟，不代表上游真实缓存命中，也不会减少上游 Token 或额度消耗。',
